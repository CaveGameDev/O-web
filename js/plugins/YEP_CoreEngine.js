...
Yanfly.Param.ScreenWidth  = Number(Yanfly.Parameters['Screen Width'] || 640);
Yanfly.Param.ScreenHeight = Number(Yanfly.Parameters['Screen Height'] || 480);
...
//=============================================================================
// FPSMeter Definition (from js/libs/fpsmeter)
//=============================================================================

// Check if FPSMeter is already defined, if not, load it
if (typeof FPSMeter === 'undefined') {
    // Simple FPSMeter implementation for compatibility
...
// Helper function to get NW.js window without require
Yanfly.getNwWindow = function() {
  if (typeof nw !== 'undefined' && nw.gui && nw.gui.Window) {
    return nw.gui.Window.get();
  }
  return null;
};
...
Yanfly.openConsole = function() {
  ...
  if (Utils.isNwjs() && Utils.isOptionValid('test')) {
    ...
    if (win) {
      win.showDevTools();
      setTimeout(Yanfly.focusWindow.bind(Yanfly, win), 500);
    }
  }
};
