...
// Check if steamworks is already defined globally
var steamworks = window.steamworks || null;

// If steamworks is not defined, create a mock/stub for non-Steam environments
if (!steamworks) {
    steamworks = {
        ...
        activateAchievement: function(achievement, callback, errorcallback) { 
            if (errorcallback) errorcallback("Steamworks not available");
        },
        clearAchievement: function(achievement, callback, errorcallback) { 
            if (errorcallback) errorcallback("Steamworks not available");
        },
        getAchievement: function(achievement, callback, errorcallback) { 
            if (callback) callback(false);
        },
        getCurrentGameLanguage: function() { return "english"; },
        getNumberOfPlayers: function(callback, errorcallback) { 
        ...
        saveTextToFile: function(file, contents, callback, errorcallback) { 
            if (errorcallback) errorcallback("Steamworks not available");
        },
        readTextFromFile: function(file, callback, errorcallback) { 
            if (errorcallback) errorcallback("Steamworks not available");
        },
        getCloudQuota: function(callback, errorcallback) { 
...
var parameters = $plugins.filter(function (plugin) {
    ...
    SceneManager.initSteamworks = function() {
        if (typeof steamworks !== 'undefined' && steamworks && steamworks.initAPI) {
    ...
    SteamManager.saveTextToCloud = function(file,contents,callback,errorcallback) {
        if (SceneManager.steamworksInitialized() && steamworks.saveTextToFile) {
      ...
      SteamManager.readTextFromCloud = function(file,callback,errorcallback) {
          if (SceneManager.steamworksInitialized() && steamworks.readTextFromFile) {
      ...
      SteamManager.isCloudSyncEnabledForUser = function() {
          if (SceneManager.steamworksInitialized() && steamworks.isCloudEnabledForUser) {
      ...
      SteamManager.isCloudEnabled = function() {
          if (SceneManager.steamworksInitialized() && steamworks.isCloudEnabled) {
      ...
      SteamManager.enableCloud = function(flag) {
          if (SceneManager.steamworksInitialized() && steamworks.enableCloud) {
      ...
      SteamManager.getCloudQuota = function(callback,errorcallback) {
          if (SceneManager.steamworksInitialized() && steamworks.getCloudQuota) {
    ...
    Game_System.prototype.getSteamUserObject = function() {
        if (SceneManager.steamworksInitialized() && steamworks.getSteamId) {
    ...
    Game_System.prototype.unlockAchievement = function(achievement,callback,errorcallback) {
      if (SceneManager.steamworksInitialized() && steamworks.activateAchievement) {
    ...
    Game_System.prototype.getAchievements = function(){
        if (SceneManager.steamworksInitialized() && steamworks.getAchievementNames) {
    ...
    Game_System.prototype.getNumberOfAchievements = function() {
        if (SceneManager.steamworksInitialized() && steamworks.getNumberOfAchievements) {
    ...
    Game_System.prototype.clearAchievement = function(achievement,callback,errorcallback) {
        if (SceneManager.steamworksInitialized() && steamworks.clearAchievement) {
    ...
    Game_System.prototype.getAchievement = function(achievement,callback,errorcallback) {
        if (SceneManager.steamworksInitialized() && steamworks.getAchievement) {
    ...
    Game_System.prototype.getCurrentGameLanguage = function() {
      if (SceneManager.steamworksInitialized() && steamworks.getCurrentGameLanguage) {
    ...
    Game_System.prototype.getNumberOfPlayers = function(callback,errorcallback) {
      if (SceneManager.steamworksInitialized() && steamworks.getNumberOfPlayers) {
    ...
    Game_System.prototype.activateGameOverlay = function(option) {
      if (SceneManager.steamworksInitialized() && steamworks.activateGameOverlay) {
          if (!option) {
              option = "Community";
          }
    ...
    Game_System.prototype.isGameOverlayEnabled = function() {
        if (SceneManager.steamworksInitialized() && steamworks.isGameOverlayEnabled) {
    ...
    Game_System.prototype.activateGameOverlayToWebpage = function(url) {
        if (SceneManager.steamworksInitialized() && steamworks.activateGameOverlayToWebPage) {
